...
var days = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]; //days start from sunday
...
var user_customize_date = new Date("May 20,2024"); //on user choice format, use inverted commas inside bracket.
